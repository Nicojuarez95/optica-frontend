      ...
      <main class="w-11/12 md:max-w-5xl mx-auto grid md:grid-cols-2 rounded">
        ...
        <div class="p-8 bg-white">
          <div class="flex gap-1 items-center justify-center">
            ...
            <h1 class="text-center text-slate-900 font-bold text-2xl">Registro</h1>
          </div>
          <p class="text-slate-500 text-center text-sm mt-2">Disfrutá de la mejor comida en la puerta de tu casa</p>
          ...
          <form class="mt-8">
            ...
            <div class="py-2">
              <label for="name" class="block font-bold text-slate-900">Nombre</label>
              <input type="name" name="name" id="name" class="w-full bg-gray-100 p-2 mt-1 border-l-4 border-red-400 focus:outline-none" placeholder="José"/>
            </div>
            <div class="py-2">
              <label for="sur_name" class="block font-bold text-slate-900">Apellido</label>
              <input type="sur_name" sur_name="sur_name" id="sur_name" class="w-full bg-gray-100 p-2 mt-1 border-l-4 border-red-400 focus:outline-none" placeholder="Peréz"/>
            </div>
            <div class="py-2">
